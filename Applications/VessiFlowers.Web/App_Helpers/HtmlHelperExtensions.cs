...
namespace VessiFlowers.Web
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string value, string attribute)
        {
            ...
            var currentId =
                (helper.ViewContext.RequestContext.RouteData.Values["id"] ?? string.Empty).ToString().UnDash();
            ...
            var hasId = value.Equals(currentId, StringComparison.InvariantCultureIgnoreCase);
